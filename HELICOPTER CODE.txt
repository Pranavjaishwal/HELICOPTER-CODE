...
renderBitmapString(move_x,0+3.8,move_z-4,GLUT_BITMAP_HELVETICA_18,"  LEVEL : ");
    ...
    glScaled(1,1,1);
renderBitmapString(move_x,6,move_z+3,GLUT_BITMAP_TIMES_ROMAN_24,"HELICOPTER GAME");
renderBitmapString(move_x,5.5,move_z+2.9,GLUT_BITMAP_HELVETICA_18,"1. SPACE TO CONTINUE");
renderBitmapString(move_x,5.1,move_z+2.9,GLUT_BITMAP_HELVETICA_18,"2. PRESS 8 FOR UP");
renderBitmapString(move_x,4.7,move_z+2.9,GLUT_BITMAP_HELVETICA_18,"3. PRESS 2 FOR DOWN");
renderBitmapString(move_x,4.3,move_z+2.9,GLUT_BITMAP_HELVETICA_18,"4. PRESS 4 FOR LEFT");
renderBitmapString(move_x,3.9,move_z+2.9,GLUT_BITMAP_HELVETICA_18,"5. PRESS 6 FOR RIGHT");
renderBitmapString(move_x,3.5,move_z+2.9,GLUT_BITMAP_HELVETICA_18,"6. PRESS ESC TO EXIT");
glColor3f(0.0f, 0.0f, 0.0f);
renderBitmapString(move_x+7,move_y+-3.4,move_z+2,GLUT_BITMAP_HELVETICA_18,"Pranav Jaishwal");
